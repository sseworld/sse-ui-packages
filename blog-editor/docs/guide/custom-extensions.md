...
If you want to add some specific attributes there, import the `mergeAttributes` helper from `@sseui/core`:

```js
import { mergeAttributes } from '@sseui/core'
...
import { markInputRule } from '@sseui/core'
...
import Strike from '@tiptap/extension-strike'
import { markPasteRule } from '@sseui/core'
...
```js
import { history } from '@sseui/pm/history'
